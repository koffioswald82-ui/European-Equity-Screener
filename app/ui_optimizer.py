...
if len(valid) < 2:
    st.error("Not enough valid tickers. Try adding more or selecting a shorter period.")
    st.stop()
...
with col2:
    fig3 = px.bar(wdf, x="ticker", y="weight_pct",
                  title="Weight per ticker (%)", color="weight_pct",
